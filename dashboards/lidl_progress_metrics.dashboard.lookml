...
#     explore: lidl_tracker
#     type: single_value
#     fields: [lidl_tracker.total_files_approved]
#     listen:
#       Department: lidl_tracker.department
#     custom_color: "#137333" # Green
#     show_single_value_title: true
#     single_value_title: "Total Files Approved"
#     value_format: "0.00"
...
#   - name: files_pending_approval
#     title: "Files Pending Approval"
#     model: lidl_project_tracker
#     explore: lidl_tracker
#     type: single_value
#     fields: [lidl_tracker.total_files_pending_approval]
#     listen:
#       Department: lidl_tracker.department
#     custom_color: "#137333" # Green
#     show_single_value_title: true
#     single_value_title: "Total Files Pending Approval"
#     value_format: "0.00"
#     note_state: collapsed
#     note_display: below
#     row: 2
...
#   - name: files_not_approved
#     title: "Files Not Approved"
#     model: lidl_project_tracker
#     explore: lidl_tracker
#     type: single_value
#     fields: [lidl_tracker.total_files_rejected]
#     listen:
#       Department: lidl_tracker.department
#     custom_color: "#137333" # Green
#     show_single_value_title: true
...
- dashboard: lidl_gws_transition_metrics
  ...
  # --- Row 2: Main Funnel (5 Tiles totaling 24 columns) ---
  - name: kpi_total_scope
    title: "Total Scope"
    model: lidl_project_tracker
    explore: lidl_tracker
  ...
  # --- Row 6: Approval Sub-Metrics (3 Tiles totaling 24 columns) ---
  - name: approved_files
    title: "Approved Files"
    model: lidl_project_tracker
    explore: lidl_tracker
  ...
  - name: files_pending_approval
    ...
    listen:
      Department: lidl_tracker.department
    custom_color: "#F4B400" # Changed to yellow/orange for 'Pending' visibility
    show_single_value_title: true
    single_value_title: "Total Files Pending Approval"
    # value_format: "0.00"
    note_state: collapsed
