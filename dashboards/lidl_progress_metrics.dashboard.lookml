...
#     listen:
#       Department: lidl_tracker.department
#     custom_color: "#137333" # Professional Green for actual output
#     show_single_value_title: true
#     single_value_title: "Actual Files Completed Per Day"
#     value_format: "0.00"
#     note_state: collapsed
#     note_display: below
#     note_text: "Based on completions since project start (Jan 26, 2026)."
#     row: 8
#     col: 16 # Positioned next to the Required Velocity tile
#     width: 8
#     height: 4
